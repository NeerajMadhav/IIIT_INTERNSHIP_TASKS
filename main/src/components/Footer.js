        ...
        <div className="footer__links">
          <ul className="footer__menu">
            <li className="footer__item">
              <a href="https://www.linkedin.com/in/neerajmadhav" className="footer__link">  
                <img src={link} alt=" LinkedIn" />
                {/* LinkedIn */}
              </a>
            </li>
            <li className="footer__item">
              <a href="https://github.com/NeerajMadhav" className="footer__link">
                <img src={git} alt=" GitHub" />
                {/* GitHub */}
              </a>
            </li>
            <li className="footer__item">
            <a href="mailto:neerajmadhav777@gmail.com" className="footer__link">
